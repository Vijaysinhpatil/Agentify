...
function MyAgents() {
  ...
  const AgentCardSkeleton = () => (
    <div className="relative flex min-h-[170px] flex-col rounded-2xl border border-slate-200/70 bg-white p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
      <div className="flex items-start justify-between">
        <div className="rounded-xl border border-slate-100 bg-slate-50 p-2.5">
          <Skeleton className="h-5 w-5 rounded-md bg-slate-200/80" />
        </div>
        <Skeleton className="h-2 w-2 rounded-full bg-slate-200" />
      </div>

      <div className="mt-5 space-y-2.5">
        <Skeleton className="h-4 w-4/5 rounded-md bg-slate-200/80" />
        <div className="flex items-center gap-2">
          <Skeleton className="h-3.5 w-3.5 rounded-full bg-slate-200/70" />
          <Skeleton className="h-3 w-24 rounded-md bg-slate-200/70" />
        </div>
      </div>

      <div className="mt-auto pt-5">
        <div className="flex items-center justify-between border-t border-slate-100 pt-4">
          <Skeleton className="h-2.5 w-28 rounded-md bg-slate-200/70" />
